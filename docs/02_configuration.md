...
* **Use Rolling Codes** - Will enable full rolling code support which is required for older garage door openers. This feature may be permanently enabled in the future.